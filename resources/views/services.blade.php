...
<title>Our Services — Sparkman Solutions</title>
<meta name="description" content="A complete path to elite credit: credit repair &amp; disputes, score optimization, business credit, debt validation, credit building, and financial coaching from Sparkman Solutions." />
  ...
  <div class="container hero__inner hero__inner--sub">
    <div class="hero__copy">
      ...
      <h1 class="hero__title reveal">
        ...
        <span class="txt-gold">elite credit.</span>
      </h1>
      <p class="hero__lead reveal">
        Every plan is tailored to your report. No cookie-cutter letters — just a
        full-service strategy engineered to move your score and keep it there.
      </p>
...
<section class="section services" id="services">
  <div class="container">
    <div class="section__head reveal">
      ...
      <h2 class="section__title">A Complete Path to <span class="txt-gold">Elite Credit</span></h2>
      <p class="section__sub">Every plan is tailored to your report. No cookie-cutter letters — just a strategy engineered to move your score.</p>
    </div>
    ...
    <div class="cards">
      <article class="card reveal">
        ...
        <p>We challenge inaccurate, outdated, and unverifiable negatives — collections, charge-offs, late payments and more.</p>
        <span class="card__line"></span>
      </article>
      <article class="card card--feature reveal">
        <div class="card__icon">🚀</div>
        <h3>Score Optimization</h3>
        <p>Utilization strategy, credit mix, and aging tactics that push your score into the tiers lenders love.</p>
        <span class="card__line"></span>
      </article>
      <article class="card reveal">
        <div class="card__icon">🏢</div>
        <h3>Business Credit</h3>
        <p>Build fundable business credit separate from your personal profile — from EIN setup to net-30 vendors.</p>
        <span class="card__line"></span>
      </article>
      <article class="card reveal">
        <div class="card__icon">🛡️</div>
        <h3>Debt Validation</h3>
        <p>We force collectors to prove the debt is truly yours — and remove what they can't validate.</p>
        <span class="card__line"></span>
      </article>
      <article class="card reveal">
        <div class="card__icon">📈</div>
        <h3>Credit Building</h3>
        <p>Tradelines, secured strategies, and reporting tools that add positive history fast and responsibly.</p>
        <span class="card__line"></span>
      </article>
      <article class="card reveal">
        <div class="card__icon">🎯</div>
        <h3>Financial Coaching</h3>
        <p>1-on-1 guidance so your new score stays high — budgeting, funding readiness, and wealth habits.</p>
        <span class="card__line"></span>
      </article>
    </div>
  </div>
