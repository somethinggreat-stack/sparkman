...
<title>About Javon Sparkman — Sparkman Solutions</title>
<meta name="description" content="Meet Javon Sparkman, founder of Sparkman Solutions — a full-service credit restoration firm trusted by thousands, built on transparency, personal strategy, and real results." />
...
<section class="hero hero--sub" id="home">
  ...
  <div class="container hero__inner hero__inner--sub">
    <div class="hero__copy">
      ...
      <h1 class="hero__title reveal">Meet your<br /><span class="txt-gold">credit advocate.</span></h1>
      <p class="hero__lead reveal">Real people. Real strategy. Real results. Get to know the team fighting for your financial future.</p>
      <div class="hero__actions reveal">
        ...
        <a href="#about" class="btn btn--outline btn--lg">Our Story</a>
      </div>
    </div>
  </div>
</section>
